...
if ($resProd && mysqli_num_rows($resProd) > 0) {
    ...
    echo "<div class='col-12'>
            <div class='alert alert-warning text-center'>
                No se encontraron fuentes de poder que soporten el consumo actual ({$wattsRequeridos}W).
            </div>
          </div>";
}
